// modules/clientes.js - Módulo de Clientes (corrigido: modal e preenchimento)
window.ClientesModule = {
    ...
    async abrirOS(cliente) {
        ...
        // Aguarda o campo "cliente" existir no DOM
        const waitForFields = () => {
    ...
    async abrirOrcamento(cliente) {
        ...
        const waitForFields = () => {
            const orcCliente = document.getElementById('orc_cliente');
            if (orcCliente) {
