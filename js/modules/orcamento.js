...
window.OrcamentoModule = {
  ...
  init() {
    ...
    // Inicializa a assinatura do orçamento
    ...
    let html = `
      ...
      <table class="w-full mb-4">
        <thead class="bg-[var(--bg-secondary)]">
          <tr><th class="p-2 text-left">#</th><th class="p-2 text-left">Descrição</th><th class="p-2 text-center">Tipo</th><th class="p-2 text-center">Qtd</th><th class="p-2 text-right">V. Un.</th><th class="p-2 text-right">Subtotal</th></tr></thead>
